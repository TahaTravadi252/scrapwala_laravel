    ...
    <div class="row">
        ...
        <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="product_name" type="text" class="form-control" name="product_name" value="{{ old('product_name', $product->product_name) }}" required autofocus>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="email" class="col-md-4 control-label">Product Price</label>
                            <div class="col-md-6">
                                <input id="product_price" type="text" class="form-control" name="product_price"  value="{{ old('product_price', $product->product_price) }}" required autofocus>
                            </div>
                        </div>
                        <div class="form-group">
